;;;  http://people.cs.georgetown.edu/~squier/Teaching/HardwareFundamentals/LC3-trunk/docs/LC3-assemblyCheatSheet.asm
...
data: .fill x00ff    ;----[x0208] Asm directive: insert x00ff into this word.
buff: .blkw #4       ;----[x0209] Asm directive: insert x0000 into 4 words.
...
;-- NB--Addresses are x0200+offset; i.e., ".ORIG x0200"
;-- sets the starting location counter, LC, to x0200. To
;-- get a symbol table of just the offsets, use ".ORIG x0000".
;---------------------------------------
// Symbol table
// Scope level 0:
